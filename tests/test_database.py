...
class TestDatabase:
    ...
    # Тест проверяет, что доступны 3 булки,
    # по индексу вызывается правильное название булки и её цена
    ...
    # Тест проверяет, что доступны 6 ингредиентов,
    # по индексу вызывается правильный тип, название ингредиента и его цена
